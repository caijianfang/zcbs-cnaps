 ...
 * generated in the com.zcbspay.platform.cnaps.beps.bean.BatchCustomersContractManageRequest package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:beps:2010:tech:xsd:beps.392.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zcbspay.platform.cnaps.beps.bean.BatchCustomersContractManageRequest
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:beps:2010:tech:xsd:beps.392.001.01", name = "Document")
