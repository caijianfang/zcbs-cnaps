 ...
 * generated in the com.zcbspay.platform.channel.beps.bean.batchcollectionchargesresponse package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:beps:2010:tech:xsd:beps.381.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zcbspay.platform.channel.beps.bean.batchcollectionchargesresponse
     * 
     */
    ...
    /**
     * Create an instance of {@link BtchColltnChrgsRspnInf1 }
     * 
     */
    public BtchColltnChrgsRspnInf1 createBtchColltnChrgsRspnInf1() {
        return new BtchColltnChrgsRspnInf1();
    }
    ...
    /**
     * Create an instance of {@link BtchColltnChrgsRspnV01 }
     * 
     */
    public BtchColltnChrgsRspnV01 createBtchColltnChrgsRspnV01() {
        return new BtchColltnChrgsRspnV01();
    }
    ...
    /**
     * Create an instance of {@link RcvgDtls1 }
     * 
     */
    public RcvgDtls1 createRcvgDtls1() {
        return new RcvgDtls1();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:beps:2010:tech:xsd:beps.381.001.01", name = "Document")
