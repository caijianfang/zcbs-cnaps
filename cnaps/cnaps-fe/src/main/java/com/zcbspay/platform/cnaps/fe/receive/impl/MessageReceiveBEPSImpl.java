...
@Service("messageReceiveBEPS")
public class MessageReceiveBEPSImpl implements MessageReceive {

    private static final Logger logger = LoggerFactory.getLogger(MessageReceiveBEPSImpl.class);
    ...
    @Resource
    private MessageListener messageListenerBEPS;
    ...
    public void receiveMsg(String message) {
        ...
        try {
            init(MessageCodeEnum.BEPS.getCode());
            conn.start();
            receiver.setMessageListener(messageListenerBEPS);
        }
