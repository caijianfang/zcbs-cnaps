 ...
 *         &lt;element name="Undrlyg" type="{urn:iso:std:iso:20022:tech:xsd:camt.055.001.01}UnderlyingTransaction1" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomerPaymentCancellationRequestV01 {
    ...
    protected List<UnderlyingTransaction1> undrlyg;
     ...
     * 
     */
    public List<UnderlyingTransaction1> getUndrlyg() {
        if (undrlyg == null) {
            undrlyg = new ArrayList<UnderlyingTransaction1>();
        }
        return this.undrlyg;
    }
