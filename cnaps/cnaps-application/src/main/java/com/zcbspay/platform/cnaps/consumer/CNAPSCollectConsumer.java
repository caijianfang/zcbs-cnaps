...
public class CNAPSCollectConsumer implements ApplicationListener<ContextRefreshedEvent>{
	...
	public void startConsume() throws InterruptedException, MQClientException {
		 ...
		 */
		DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(RESOURCE.getString("cnaps.collect.producer.group"));
		consumer.setConsumeFromWhere(ConsumeFromWhere.CONSUME_FROM_FIRST_OFFSET);
		consumer.setNamesrvAddr(RESOURCE.getString("single.namesrv.addr"));
		consumer.setInstanceName(RESOURCE.getString("cnaps.collect.instancename"));
		String subExpression = "";
		for(CNAPSCollectTagsEnum tagsEnum:CNAPSCollectTagsEnum.values()){
		...
		consumer.subscribe(RESOURCE.getString("cnaps.collect.subscribe"), subExpression);
