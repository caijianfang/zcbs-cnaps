 ...
 * generated in the com.zcbspay.platform.cnaps.beps.bean.RealTimePaymentByAgencyResponse package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:beps:2010:tech:xsd:beps.387.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zcbspay.platform.cnaps.beps.bean.RealTimePaymentByAgencyResponse
     * 
     */
    ...
    /**
     * Create an instance of {@link RealTmPmtByAgcyRspnInf1 }
     * 
     */
    public RealTmPmtByAgcyRspnInf1 createRealTmPmtByAgcyRspnInf1() {
        return new RealTmPmtByAgcyRspnInf1();
    }

    /**
     * Create an instance of {@link RealTmPmtByAgcyRspnV01 }
     * 
     */
    public RealTmPmtByAgcyRspnV01 createRealTmPmtByAgcyRspnV01() {
        return new RealTmPmtByAgcyRspnV01();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:beps:2010:tech:xsd:beps.387.001.01", name = "Document")
