 ...
 * generated in the com.zcbspay.platform.cnaps.beps.bean.RealTimePaymentByAgency package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:beps:2010:tech:xsd:beps.386.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zcbspay.platform.cnaps.beps.bean.RealTimePaymentByAgency
     * 
     */
    ...
    /**
     * Create an instance of {@link RealTmPmtByAgcyInf1 }
     * 
     */
    public RealTmPmtByAgcyInf1 createRealTmPmtByAgcyInf1() {
        return new RealTmPmtByAgcyInf1();
    }
    ...
    /**
     * Create an instance of {@link RealTmPmtByAgcyV01 }
     * 
     */
    public RealTmPmtByAgcyV01 createRealTmPmtByAgcyV01() {
        return new RealTmPmtByAgcyV01();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:beps:2010:tech:xsd:beps.386.001.01", name = "Document")
