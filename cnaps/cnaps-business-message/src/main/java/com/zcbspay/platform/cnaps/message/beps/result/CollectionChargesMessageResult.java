 ...
 */
@Service
public class CollectionChargesMessageResult {

	public ResultBean batchCollectionChargesResult(SendResult sendResult){
		
		return null;
	}
	
	public ResultBean realTimeCollectionChargesResult(SendResult sendResult){
		return null;
	}
}
