 ...
 * generated in the com.zcbspay.platform.cnaps.ccms.bean.BankCodeChangeNotification package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:ccms:2010:tech:xsd:ccms.916.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zcbspay.platform.cnaps.ccms.bean.BankCodeChangeNotification
     * 
     */
    ...
    /**
     * Create an instance of {@link BkCdChngNtfctnV01 }
     * 
     */
    public BkCdChngNtfctnV01 createBkCdChngNtfctnV01() {
        return new BkCdChngNtfctnV01();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:ccms:2010:tech:xsd:ccms.916.001.01", name = "Document")
