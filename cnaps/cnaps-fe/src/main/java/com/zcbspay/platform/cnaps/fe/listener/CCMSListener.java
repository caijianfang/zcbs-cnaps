...
@Service("messageListenerCCMS")
public class CCMSListener implements MessageListener {

    private static final Logger logger = LoggerFactory.getLogger(CCMSListener.class);
