 ...
 * @since
 */
public class CNAPSCollectProducer implements Producer {
	private final static Logger logger = LoggerFactory.getLogger(CNAPSCollectProducer.class);
	...
	public CNAPSCollectProducer(String namesrvAddr, CNAPSCollectTagsEnum tags) throws MQClientException {
		logger.info("【初始化CNAPSCollectProducer】");
		...
		logger.info("【初始化CNAPSCollectProducer结束】");
	}
