 ...
 * generated in the com.zcbspay.platform.cnaps.beps.bean.RealTimeCollectionChargesResponse package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:cnaps:std:beps:2010:tech:xsd:beps.385.001.01", "Document");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zcbspay.platform.cnaps.beps.bean.RealTimeCollectionChargesResponse
     * 
     */
    ...
    /**
     * Create an instance of {@link RealTmColltnChrgsRspnInf1 }
     * 
     */
    public RealTmColltnChrgsRspnInf1 createRealTmColltnChrgsRspnInf1() {
        return new RealTmColltnChrgsRspnInf1();
    }
    ...
    /**
     * Create an instance of {@link RealTmColltnChrgsRspnV01 }
     * 
     */
    public RealTmColltnChrgsRspnV01 createRealTmColltnChrgsRspnV01() {
        return new RealTmColltnChrgsRspnV01();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:cnaps:std:beps:2010:tech:xsd:beps.385.001.01", name = "Document")
