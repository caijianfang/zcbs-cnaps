 ...
 *         &lt;element name="SndTtlAmt" type="{urn:cnaps:std:beps:2010:tech:xsd:beps.726.001.01}SummaryAmountText"/>
 *         &lt;element name="RcvTtlCnt" type="{urn:cnaps:std:beps:2010:tech:xsd:beps.726.001.01}Max8NumericText"/>
 *         &lt;element name="RcvTtlAmt" type="{urn:cnaps:std:beps:2010:tech:xsd:beps.726.001.01}SummaryAmountText"/>
...
public class CheckInformationDetails1 {
    ...
    protected List<SendDetails1> sndDtls1;
    @XmlElement(name = "RcvDtls1")
    protected List<ReceiveDetails1> rcvDtls1;
    ...
    public List<SendDetails1> getSndDtls1() {
        if (sndDtls1 == null) {
            sndDtls1 = new ArrayList<SendDetails1>();
        }
    ...
    public List<ReceiveDetails1> getRcvDtls1() {
        if (rcvDtls1 == null) {
            rcvDtls1 = new ArrayList<ReceiveDetails1>();
        }
